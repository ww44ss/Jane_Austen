...
```{r, "load jane austen text", echo=FALSE}
...
```{r, "functional wrapper for get_sentiment"}
...
```{r, "process using different methods"}
...
```{r, "plot different methods", fig.align='center', fig.height=4, fig.width=8}
...
```{r, , "process sentiment Northanger", echo=FALSE}
...
```{r, , "process sentiment Persuassion", echo=FALSE}
...
```{r, , "process sentiment S and S", echo=FALSE}
